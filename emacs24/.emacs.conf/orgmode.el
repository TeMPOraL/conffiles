(try-load-and-configure-library
 ...
 (defconst +trc-org-feeds-file+ "~/Dropbox/GTD/feeds.org")
...
;  '((ditaa . t)))
 ...
 ;; Capture
 (setq org-default-notes-file "~/Dropbox/GTD/capture.org")

 (setq org-capture-templates
	   '(("t" "TODO" entry
		  (file+headline "~/Dropbox/GTD/stuff.org" "Tasks")
		  "* TODO %?\n  %i\n  %a")
		 ("j" "Journal" entry
		  (file+headline "~/Dropbox/GTD/journal.org" "Quick Notes")
		  "* %T\n  %i\n  %?")
		 ("w" "Web link" entry
		  (file+headline "~/Dropbox/GTD/stuff.org" "RnR Web link")
		  "* TODO %c\n  %?")
		 ("b" "Bookmark" entry
		  (file "~/Dropbox/GTD/bookmarks.org")
		  "* %c\n  %T\n  %?")
		 ("n" "Note" entry
		  (file+headline "~/Dropbox/GTD/stuff.org" "Notes")
		  "* %T\n  %i\n   %?")
		 ("q" "Question" entry
		  (file+headline "~/Dropbox/GTD/stuff.org" "Questions")
		  "* TODO Question: %?")
		 ("u" "Quote" entry
		  (file "~/Dropbox/GTD/quotes.org")
		  "* %c\n  %?")
		 ("l" "Blacklist" entry
		  (file "~/Dropbox/GTD/blacklist.org")
		  "* %c\n   %T\n   %?")))
